...
export const INFORMATIVE_TIPS = [
  ...
  'Create a project-specific OPENAGENT.md file with /init',
  ...
  'Reload instructional context from OPENAGENT.md files with /memory reload',
  'List the paths of the OPENAGENT.md files in use with /memory list',
